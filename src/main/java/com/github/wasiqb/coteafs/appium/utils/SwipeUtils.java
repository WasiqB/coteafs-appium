...
public final class SwipeUtils {
     ...
     */
    public static <T extends TouchAction<T>> T dragTo(final PlaybackSetting setting, final MobileElement fromElement,
        ...
        return actions.press(PointOption.point(source.getX(), source.getY()))
            ...
            .release()
            .waitAction(WaitOptions.waitOptions(Duration.ofMillis(setting.getDelayAfterSwipe())));
    }
