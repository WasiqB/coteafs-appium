...
/**
 * @author wasiq.bhamla
 * @since Feb 1, 2018 2:59:40 PM
 */
public class VerticleSwipeActivity extends DefaultActivity {
	/**
	 * @author wasiq.bhamla
	 * @since Feb 1, 2018 2:59:41 PM
	 * @param device
	 */
	public VerticleSwipeActivity (final AndroidDevice device) {
		super (device);
	}
